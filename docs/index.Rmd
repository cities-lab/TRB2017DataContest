...
## Visualization
### Temporal Variation of Flow by Day of Week and Trip Purpose 
We first visualize the temporal variation of flow by day of week and trip purpose. We expect the 
...
Next we visualize the spatial patterns of trip counts in the AirSage data. We are interested in the hour by hour net trips at the TAZ level (for each TAZ, net trips = trips destinated - trips originated).  
```{r maps, include=F}
